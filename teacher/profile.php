...
requireTeacher(); // Kiểm tra quyền Giảng viên

$user_id = $_SESSION['user_id'] ?? 0;

// Lấy thông tin giảng viên hiện tại từ CSDL
        ...
        if ($checkEmail->fetchColumn() > 0) {
            ...
            if (isset($_FILES['avatar']) && $_FILES['avatar']['error'] === UPLOAD_ERR_OK) {
                ...
                if (!in_array($fileExt, $allowedExtensions)) {
                    ...
                    $newFileName = 'avatar_teacher_' . $user_id . '_' . time() . '.' . $fileExt;
...
$avatarUrl = !empty($currentUser['avatar']) && file_exists('../' . $currentUser['avatar'])
    ...
    : 'https://ui-avatars.com/api/?name=' . urlencode($currentUser['name']) . '&background=198754&color=fff&size=200';

$page_title = 'Hồ sơ cá nhân Giảng viên';
...
<div class="page-wrapper">
    ...
    <div class="main-content">
        ...
        <div class="topbar">
            <div>
                <h4 class="mb-1">Hồ sơ Giảng viên</h4>
                <p class="text-muted mb-0">Quản lý thông tin tài khoản, ảnh đại diện và bảo mật</p>
            </div>
            <span class="badge bg-success fs-6 px-3 py-2"><i class="bi bi-person-badge me-1"></i> Giảng viên</span>
        </div>
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="position-relative d-inline-block mb-3">
                            <img id="avatarPreview" src="<?= $avatarUrl ?>" 
                                 ...
                                 alt="Avatar Teacher">
                            <label for="avatarInput" class="position-absolute bottom-0 end-0 bg-success text-white rounded-circle p-2 shadow cursor-pointer" 
                        ...
                        <div class="d-flex justify-content-center gap-2 mb-3">
                            <span class="badge bg-success-subtle text-success border border-success-subtle px-3 py-2">
                                <i class="bi bi-mortarboard"></i> Giảng viên
                            </span>
                            <span class="badge bg-success-subtle text-success border border-success-subtle px-3 py-2">
                        ...
                        <div class="text-start">
                            <div class="d-flex justify-content-between py-2 border-bottom">
                                <span class="text-muted"><i class="bi bi-hash me-1"></i> Mã Giảng viên / ID:</span>
                    ...
                    <div class="card-body p-4">
                        <form method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control bg-light" value="Giảng viên" readonly disabled>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="alert alert-info d-flex align-items-center mt-3 mb-0 p-2 small">
                                ...
                                <div>Bấm vào biểu tượng <strong>máy ảnh</strong> trên hình đại diện bên trái để tải ảnh mới lên (định dạng JPG, PNG, WEBP, GIF, tối đa 2MB), sau đó bấm <strong>Lưu thay đổi</strong>.</div>
                            </div>

                            <div class="mt-4 text-end">
                                <button type="submit" name="update_profile" value="1" class="btn btn-success px-4">
...
<script>
// JavaScript xử lý xem trước ảnh (Preview)
