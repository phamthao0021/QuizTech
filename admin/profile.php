...
// (Giống luồng xử lý trang Student)
// -------------------------------------------------------------
            ...
            if (isset($_FILES['avatar']) && $_FILES['avatar']['error'] === UPLOAD_ERR_OK) {
                ...
                if (!in_array($fileExt, $allowedExtensions)) {
                    ...
                    if (move_uploaded_file($fileTmpPath, $destPath)) {
                        ...
                        // Lưu đường dẫn tương đối giống trang Student
...
<div class="page-wrapper">
    ...
    <div class="main-content">
        ...
        <div class="topbar">
            <div>
                <h4 class="mb-1">Thẻ cá nhân Admin</h4>
                <p class="text-muted mb-0">Quản lý hồ sơ, ảnh đại diện và thiết lập bảo mật</p>
            </div>
            <span class="badge bg-danger fs-6 px-3 py-2"><i class="bi bi-shield-check me-1"></i> Quản trị viên</span>
        </div>
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="text-start">
                            <div class="d-flex justify-content-between py-2 border-bottom">
                                <span class="text-muted"><i class="bi bi-hash me-1"></i> ID Tài khoản:</span>
                ...
                <div class="card shadow-sm border-0 mb-4">
                    ...
                    <div class="card-body p-4">
                        <form method="POST" enctype="multipart/form-data">
                            ...
                            <!-- Input chọn ảnh đại diện ẩn (Được kích hoạt khi bấm nút camera trên ảnh) -->
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control bg-light" value="Administrator (Quản trị cao nhất)" readonly disabled>
                                    </div>
                                </div>
                            </div>
...
<script>
// JavaScript xử lý xem trước ảnh (Preview) ngay khi người dùng chọn file
